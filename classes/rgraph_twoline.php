...
class twoline {
	...
	public function Draw() {
        ...
        $this->chart .= "<script> window.onload = function () {\n";
    ...
    private function ChartOptions() {
		...
		$this->chart .= $this->name.".Set('chart.fillstyle', ['yellow', 'green']);\n";
		...
		*/
		...
		$this->chart .= $this->name.".Set('chart.gutter', 85);\n";
		...
		// CALC THE MAX
		$max = $this->total_line1+5;
		if ($this->total_line2 > $this->total_line1) {
			$max = $this->total_line2 +5;
		}
